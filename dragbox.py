...
class ExampleApp(tk.Tk):
    def __init__(self):
        ...
        self.button_print = tk.Button(self, text = "Display points", command =lambda: self.print_points())
        self.button_print.pack(side="top", fill="both", expand=True)
        self.button_clear = tk.Button(self, text = "Clear", command = lambda: self.clear_all)
